// Content database - Anne Marie Clements nervesystemsterapi
const content = {
    circles: {
        nervesystem: {
            klient: {
    ...
    connections: {
        ...
        'polyvagal-psykobiologi': {
            klient: "Når du er i den grønne sikre tilstand, fungerer din biologioptimalt - god søvn, stærkt immunforsvar, god fordøjelse. I alarm eller nedlukning går alt i ubalance.",
