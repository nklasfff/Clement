...
// UDDANNELSER - STRUKTUR KLAR TIL FASE 2 INDHOLD
const educations = {
    nervesystemsterapeut: {
        name: "Nervesystemsterapeut",
        circles: {
            nervesystem: {
                kursist: { title: "Nervesystemsterapeut", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Nervesystemsterapeut - Fagligt", text: "[Fase 2 indhold]" }
            },
            polyvagal: {
                kursist: { title: "Polyvagal Teori", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Polyvagal - Fagligt", text: "[Fase 2 indhold]" }
            },
            tilknytning: {
                kursist: { title: "Tilknytningsmønstre", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Tilknytning - Fagligt", text: "[Fase 2 indhold]" }
            },
            kropsterapi: {
                kursist: { title: "Kropsterapi", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Kropsterapi - Fagligt", text: "[Fase 2 indhold]" }
            },
            psykobiologi: {
                kursist: { title: "Psykobiologi", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Psykobiologi - Fagligt", text: "[Fase 2 indhold]" }
            },
            traumer: {
                kursist: { title: "Traumer", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Traumer - Fagligt", text: "[Fase 2 indhold]" }
            },
            relation: {
                kursist: { title: "Relation", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Relation - Fagligt", text: "[Fase 2 indhold]" }
            }
        },
        connections: {}
    },
...
        circles: {
            nervesystem: {
                kursist: { title: "Teacher Training", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Teacher Training - Fagligt", text: "[Fase 2 indhold]" }
            },
            polyvagal: {
                kursist: { title: "Polyvagal i Ledelse", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Polyvagal - Fagligt", text: "[Fase 2 indhold]" }
            },
            tilknytning: {
                kursist: { title: "Tilknytning i Ledelse", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Tilknytning - Fagligt", text: "[Fase 2 indhold]" }
            },
            kropsterapi: {
                kursist: { title: "Embodied Ledelse", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Kropsterapi - Fagligt", text: "[Fase 2 indhold]" }
            },
            psykobiologi: {
                kursist: { title: "Biologi i Ledelse", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Psykobiologi - Fagligt", text: "[Fase 2 indhold]" }
            },
            traumer: {
                kursist: { title: "Trauma-informeret Ledelse", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Traumer - Fagligt", text: "[Fase 2 indhold]" }
            },
            relation: {
                kursist: { title: "Relationel Ledelse", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Relation - Fagligt", text: "[Fase 2 indhold]" }
            }
        },
        connections: {}
...
        circles: {
            nervesystem: {
                kursist: { title: "3-dages Kursus", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Tilknytningsspeciale - Fagligt", text: "[Fase 2 indhold]" }
            },
            polyvagal: {
                kursist: { title: "Polyvagal og Tilknytning", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Polyvagal - Fagligt", text: "[Fase 2 indhold]" }
            },
            tilknytning: {
                kursist: { title: "4 Tilknytningsmønstre", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Tilknytning - Fagligt", text: "[Fase 2 indhold]" }
            },
            kropsterapi: {
                kursist: { title: "Embodied Tilknytning", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Kropsterapi - Fagligt", text: "[Fase 2 indhold]" }
            },
            psykobiologi: {
                kursist: { title: "Tilknytningens Biologi", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Psykobiologi - Fagligt", text: "[Fase 2 indhold]" }
            },
            traumer: {
                kursist: { title: "Tilknytningstraumer", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Traumer - Fagligt", text: "[Fase 2 indhold]" }
            },
            relation: {
                kursist: { title: "Relationel Healing", text: "[Fase 2 indhold]" },
                fagfolk: { title: "Relation - Fagligt", text: "[Fase 2 indhold]" }
            }
        },
        connections: {}
